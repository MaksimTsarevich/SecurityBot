...
enum AnimationDuration {
    case laborious, plodding, strolling, brisk, noAnimation, random
...
final class AnimatedLabel: UILabel {
    ...
    private func setTextValue(value: Float) {
        text = "SCANNING " + String(format: customFormatBlock?() ?? decimalPoints.format, value) + "%"
    }
}
